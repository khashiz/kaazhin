...
$htag    = $this->params->get('show_page_heading') ? 'h1' : 'h2';
...
<div class="com-content-article item-page<?php echo $this->pageclass_sfx; ?>" itemscope itemtype="https://schema.org/Article">
	...
	<div class="page-header">
		<<?php echo $htag; ?> itemprop="headline" class="uk-text-secondary font f700 uk-h3 ss02">
	...
	<div itemprop="articleBody" class="uk-text-justify uk-text-secondary uk-margin-medium-bottom f500 com-content-article__body"><?php echo $this->item->text; ?></div>
